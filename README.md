...
![Color Detection Sample](assets/street.png)
...
# Getting Started
* [demo.ipynb](samples/demo.ipynb) Is the easiest way to start. It shows an example of using an Open-CV to Detect Color in your own videos.
